...
export default function Navbar({ user }: { user: any }) {
  ...
  return (
    <div className="z-50 fixed w-full flex justify-between items-center py-[20px] pl-[40px] text-base-content bg-base-100 duration-450 max-lg:bg-transparent max-lg:justify-end">
        {/* Menu */}
